...
function GenerateGrid(parameter) {
    $("#gridview").empty();
    $("#gridview").append("<div id='gvLaporanBarangMasuk' style='width:100%;'></div>");

        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: get_uri() + "/api/pembelian/laporanbarangmasuk/"+parameter.tglMasuk+"/"+parameter.tglKeluar,
        ...
        grid = $("#gvLaporanBarangMasuk").kendoGrid({
